...
namespace Hanafalah\ModuleEmployee\Facades;
 ...
 */
class ModuleEmployee extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleEmployee\Contracts\ModuleEmployee::class;
  }
}
